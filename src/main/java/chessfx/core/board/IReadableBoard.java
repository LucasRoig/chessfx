...
public interface IReadableBoard {
	 ...
	 * 
	 * @param s
	 *            la case dont on veut connaitre l'occupant
	 */
	...
	/**
	 * Renvoie la case sur laquelle la prise en passant est possible Renvoie
	 * NoSquare si aucune prise en passant n'est possible
	 * 
	 * @return
	 */
